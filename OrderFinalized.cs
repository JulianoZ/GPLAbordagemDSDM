...
public class OrderFinalized {
 ...
 private int payment_idPayment;

 public int getPayment_idPayment() {
  return payment_idPayment;
 }

 public void setPayment_idPayment(int payment_idPayment) {
 ...
 public void setStatusOrderLocal(int statusOrderLocal) {
  this.statusOrderLocal = statusOrderLocal;
 }
 private String note;
